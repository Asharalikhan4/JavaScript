...
const EqualityOperator: FC = () => {
    return (
        <CustomComponent id="equality-operator">
            ...
            <p>- <CustomText>==</CustomText> performs type coercion and checks if the values are equal after possible type conversion.</p>
            <p>- <CustomText>===</CustomText> checks for strict equality, meaning it compares both the values and their data types without type coercion.</p>
