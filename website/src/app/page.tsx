  ...
  return (
    <main className="h-[90%] flex items-center justify-center">
      <div className="h-full flex flex-col items-center justify-center gap-y-4 md:gap-y-2">
        ...
        <Link href={"/technologies"} className="border-2 border-[#005B41] dark:border-violet-500 hover:bg-[#005B41] dark:hover:bg-violet-500 px-16 py-2 md:px-6 md:py-1 rounded-md transition duration-300 ease-in-out dark:hover:text-black hover:text-white hover:font-medium">Next</Link>
      </div>
    </main>
  );
};