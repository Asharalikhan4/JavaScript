# Function and this in JavaScript
...
The value of this is decided upon how the function is invoked, each invocation creates its own context and the context decides the value of this. Also the ["strict mode"](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Strict_mode) affects the behavior of this too.

## Value of "this" when invoked as a normal function
The value of this in the function invocation refers to the global object. [window](https://developer.mozilla.org/en-US/docs/Web/API/Window) in the browser and [global](https://developer.mozilla.org/en-US/docs/Glossary/Global_object) in nodejs.
```js
function example(){
...
To access the value of the parent we can use either the [Fat arrow function](https://learnersbucket.com/tutorials/es6/fat-arrow-function/) or indirect invocation technique using call & apply,

The fat arrow function does not have the this of its own, it access the this in its nearest scope.In the below example, the fat arrow's this refers to the this of displayBlog() which refers to the this of the object it is part of.
```js
const example = {
  blog: 'learnersbucket',
  displayBlog: function(){
